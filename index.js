  ...
  return `
    <li class='js-item-element' data-item-id='${item.id}'>
      ...
      <div class='shopping-item-controls'>
        ...
        <button class='shopping-item-changeName js-item-changeName'>
          <span class='button-label'>Change Name</span>
        </button>
      </div>
    </li>`;
};
...
const render = function () {
  ...
  // // If the changeNameofItem propert is true
  // // then we want to render a special page
  // if (store,changeNameofItem) {
   ...
   */
  if (store.changeNameofItem){
    const shoppingListItemsString = generateChangeNameString(itemId);
  } else {
...
function generateChangeNameString(itemId){
  return `<form id="js-change-name-form">
      <label for="shopping-list-change">Add an item</label>
      <input type="text" name="shopping-list-change" class="js-shopping-list-change" placeholder="new name">
...
const changeName = function (itemId){
//console.log(itemId)
  store.changeNameofItem === true;
}
const handleChangeNameClicked = function () {
  $('.js-shopping-list').on('click', '.js-item-changeName', event => {
    const id = getItemIdFromElement(event.currentTarget);
    changeName(id);
    render();
  });
